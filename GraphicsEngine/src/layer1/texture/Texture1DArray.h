...
public:
	...
	Texture1DArray(const std::string& identifier, GLint internalFormat, boost::int32_t width, GLenum format, GLenum type, bool mipMap, GLint minFilter, GLint magFilter, GLint wrapS, GLint wrapT, float anisotropic);
