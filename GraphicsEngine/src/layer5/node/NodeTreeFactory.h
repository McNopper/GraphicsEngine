...
public:
	...
	bool setTranslationLimits(const std::string& name, bool minActive, float min, bool maxActive, float max, std::int32_t index) const;
	bool setRotationLimits(const std::string& name, bool minActive, float min, bool maxActive, float max, std::int32_t index) const;
	bool setScalingLimits(const std::string& name, bool minActive, float min, bool maxActive, float max, std::int32_t index) const;
